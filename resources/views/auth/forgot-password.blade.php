...
@section('title', 'Forgot Password - BookStore')
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            <div class="flex justify-center">
                <div class="w-16 h-16 bg-gradient-to-br from-gray-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl">
            ...
            <p class="mt-2 text-sm text-gray-600">No problem! Enter your email and we'll send you a reset link.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <!-- Back to Login -->
                <div class="text-center">
                    <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-500 font-medium text-sm transition-colors">
                        ← Back to Login
                    </a>
                </div>
            </form>
