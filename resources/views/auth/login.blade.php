    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            <div class="flex justify-center">
                <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl transform hover:rotate-12 transition-transform duration-500">
            ...
            <p class="mt-2 text-sm text-gray-600">Sign in to your BookStore account</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <!-- Register Link -->
                <div class="text-center">
                    <a href="{{ route('register') }}" class="btn btn-outline w-full magnetic ripple">
                        Create New Account
                    </a>
                </div>
            </form>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
            ...
            <div class="text-xs text-blue-700 space-y-1">
                <p><strong>Admin:</strong> admin@bookstore.com / password</p>
                <p><strong>User:</strong> user@bookstore.com / password</p>
            </div>
        </div>
    </div>
</div>
